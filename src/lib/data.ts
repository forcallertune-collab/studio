...
export const initialOrders: Order[] = [
    ...
    { id: 'SAMPLE-YT-COMMENT-1', userId: 'sample-user', user: 'Sample Advertiser', service: 'YouTube Comments', link: 'https://www.youtube.com/watch?v=VIDEO_ID_FOR_COMMENTS', quantity: 100, amount: 50, status: 'in progress', date: "2024-08-01T12:00:00.000Z", progress: 0 },
